...
public class VendorService {
	...
	/*public ResponseEntity<ResponseStructure<Vendor>> updateVendor(Vendor vendor) {
		...
		if (vendor2 != null) {
			...
			vendor2.setPhone(vendor.getPhone());
			vendor2.setRole(vendor.getRole());
			vendor2.setCostPerDay(vendor.getCostPerDay());
			responseStructure.setData(vendor2);
			responseStructure.setData(vendorDao.updateVendor(vendor2));
	...
	public ResponseEntity<ResponseStructure<com.homeservo.duplicate.Vendor>> getById(int id) {
		...
		if (vendor != null) {
			...
			com.homeservo.duplicate.Vendor vendor1 = (com.homeservo.duplicate.Vendor)this.modelMapper.map(vendor ,com.homeservo.duplicate.Vendor.class);
